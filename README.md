...
* **`bench_ex1.c` / `ex1_generic.c` / `short.c`**: Solution codes for ex1 (short.c was done just to use the accumulator with different type than the number that were short to have logical output of the sum).
